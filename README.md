...
*A mostly reasonable approach to JavaScript*. Based on [Airbnb's.](https://github.com/airbnb/javascript).
...
## Semicolons
  ...
  <a name="semicolons-not-required"></a><a name="20.1"></a>
  - [21.1](#semicolons-not-required) Avoid! We prefer not to use semicolons, for brevity and lazyness.
...
## Testing
  <a name="testing"></a><a name="28.2"></a>
  - [30.2](#testing)
